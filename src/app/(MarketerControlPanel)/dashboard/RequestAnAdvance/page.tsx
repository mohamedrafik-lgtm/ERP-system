    ...
    return (
        <div>
            <div className="w-6/12 bg-white/20 p-4 rounded-xl mx-auto mt-14 space-y-10">
                  <div>
                      <h1 className="text-white text-4xl text-center">تقديم طلب سلفه</h1>
                  </div>

                  <form className="space-y-5">
                     <div className=" text-white mt-3 rounded-md flex flex-col space-y-3 ">
                        <label htmlFor="searchId" className="text-white text-xl mb-3">المبلغ المطلوب :</label>
                        <Input type="number" name="search" id="searchId" className="w-full border-none rounded-xl bg-white/20 "/>
                     </div>
