...
const QuestionBankTable = () =>{
    return (
      <div dir="" className=" space-y-4">
        {/* عنوان الأعمدة */}
        <div className="grid grid-cols-3 bg-white  font-bold text-sm p-2 rounded-md">
        ...
        {Bank.map((matial) => (
          <div
            key={matial.id}
            className="grid grid-cols-3 items-center bg-white hover:text-white backdrop-blur-md rounded-xl  p-2 shadow-sm hover:shadow-md hover:bg-orange-600 transition-all duration-200"
          >
            ...
            <div className="flex justify-center">
                <Link href={`/TrainingContentManagement/QuestionBank/${matial.id}`}>
                    <button className="px-3 py-1 cursor-pointer  hover:bg-white/40 rounded-xl">
