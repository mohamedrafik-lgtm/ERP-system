  ...
  useEffect(() => {
    ...
    return(
        ...
        >
          ...
          {isOpen && (
                <ul className={`absolute right-0 mt-6 w-52   text-white bg-slate-700 p-1 rounded-md shadow-md z-10 text-right transition-all duration-300`} onClick={()=>setIsOpen(false)}>
