...
const TraineeFeesCards = () => {
  return (
    <div className="p-4 space-y-4" dir="rtl">
      {/* Header */}
      <div className="hidden sm:grid grid-cols-11 gap-4 text-white font-bold bg-white/10 backdrop-blur p-3 rounded-lg border border-white/20">
      ...
      {payments.map((payment, idx) => (
        <div
          key={idx}
          className="grid grid-cols-1 sm:grid-cols-11 gap-4 items-center bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-xl text-white p-4 shadow transition"
        >
          ...
          <div className="text-center">{payment.paid}</div>
           ...
           <div className="flex justify-center">
            <button className="bg-white/20 hover:bg-white/40 text-white py-1 px-3 rounded-md">
                اضافه
               + 
            </button>
          </div>
          ...
          <div className="flex justify-center gap-2">
            ...
            <button className="bg-white/20 hover:bg-white/40 text-white py-1 px-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
