...
export default function TraineeFeesModal() {
  ...
  return (
    <>
      <Button
        onClick={open}
        className="bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700 focus:not-data-focus:outline-none data-focus:outline data-focus:outline-white data-hover:bg-orange-800"
      >
        + اضافه جديد
      </Button>
