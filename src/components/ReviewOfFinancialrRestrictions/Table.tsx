...
const FinancialStatementsTable = () => {
    ...
    return (
        <div className=" space-y-2">
          {/* عنوان الأعمدة */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-8 bg-white font-bold text-sm p-4 rounded-md">
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-8 gap-2 items-center">
                ...
                <div className="flex gap-2 justify-center">
                  ...
                  <button className="bg-white/20 hover:bg-white/40 p-1.5 rounded-md">
                     التفاصيل
                  </button>
                </div>
              </div>
