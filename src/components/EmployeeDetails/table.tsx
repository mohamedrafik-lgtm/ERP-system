  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {data.map((program, idx) => (
        <div
          key={program.id}
          className={`bg-white backdrop-blur-md rounded-xl p-2 shadow-sm transition-all duration-200 
            `}
        >
          <div className="grid grid-cols-3 items-center gap-2">
            ...
            <div className="flex justify-center">
              <button
                ...
                className={`px-3 py-1 rounded-md text-sm  text-white font-medium transition ${
                  program.hasAccess
